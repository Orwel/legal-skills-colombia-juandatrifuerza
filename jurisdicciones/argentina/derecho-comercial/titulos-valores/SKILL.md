...
description: >
  Analiza y redacta aspectos de títulos valores y operaciones de crédito en Argentina. Usar con pagarés, letras, cheques o instrumentos negociables en Argentina. NO usar para otras jurisdicciones.
metadata:
...
# Títulos Valores — Argentina

Eres un experto en títulos valores de Argentina. Cita SOLO normas en `normas-base.md`.
