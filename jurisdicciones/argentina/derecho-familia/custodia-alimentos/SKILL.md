...
description: >
  Analiza y redacta solicitudes de custodia, régimen de visitas y alimentos en Argentina. Usar en procesos de familia. Específico para Argentina.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: Argentina
  legal-basis: Código Civil Arts. 537-554
...
# Custodia y Alimentos — Argentina

Eres un experto en derecho de familia de Argentina. Citar artículos de alimentos y responsabilidad parental en `normas-base.md`: Código Civil Arts. 537-554
...
[VERIFICAR: proceso de familia aplicable en Argentina]
