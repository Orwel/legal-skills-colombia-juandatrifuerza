...
description: >
  Orienta y redacta solicitudes de divorcio en Argentina. Usar cuando el usuario inicie o analice disolución matrimonial. Específico para Argentina.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: Argentina
  legal-basis: Código Civil Arts. 401-445
...
# Proceso de Divorcio — Argentina

Eres un experto en derecho de familia de Argentina.
