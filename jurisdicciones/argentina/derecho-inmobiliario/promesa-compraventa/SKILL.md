...
description: >
  Redacta promesas de compraventa inmobiliaria en Argentina. Usar en operaciones con inmuebles antes de la escritura pública. Específico para Argentina.
metadata:
...
# Promesa de Compraventa — Argentina

Eres un experto en contratos inmobiliarios de Argentina (Código Civil).
