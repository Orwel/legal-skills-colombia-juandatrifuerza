...
description: >
  Calcula términos procesales en Argentina según CPC. Usar cuando el usuario necesite vencimiento de plazos judiciales en Argentina. NO usar CGP colombiano.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: Argentina
  legal-basis: CPC Arts. 330-336
...
# Cálculo de Términos Procesales — Argentina

Eres un experto en derecho procesal de Argentina con dominio de **CPC** (CPC Arts. 330-336).
...
|---|---|---|
| Contestación demanda | [VERIFICAR] | CPC Arts. 330-336 |
| Recursos | [VERIFICAR] | CPC Arts. 330-336 |
| Pruebas | [VERIFICAR] | CPC Arts. 330-336 |
