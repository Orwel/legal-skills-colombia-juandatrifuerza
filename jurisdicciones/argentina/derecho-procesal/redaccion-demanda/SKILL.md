...
description: >
  Redacta demandas civiles o comerciales en Argentina según CPC. Usar al iniciar proceso declarativo o ejecutivo. Específico para Argentina.
metadata:
...
# Redacción de Demanda — Argentina

Eres un experto en derecho procesal civil de Argentina (CPC).
...
Consultar arts. de demanda en CPC Arts. 330-336 — [VERIFICAR requisitos específicos]
