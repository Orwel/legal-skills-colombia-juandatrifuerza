...
description: >
  Orienta y redacta solicitudes de divorcio en Bolivia. Usar cuando el usuario inicie o analice disolución matrimonial. Específico para Bolivia.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: Bolivia
  legal-basis: Código Civil Arts. 450-491
...
# Proceso de Divorcio — Bolivia

Eres un experto en derecho de familia de Bolivia.

## 1. Tipos de divorcio en Bolivia
