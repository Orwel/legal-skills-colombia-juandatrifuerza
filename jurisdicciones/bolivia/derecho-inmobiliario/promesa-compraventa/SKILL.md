...
description: >
  Redacta promesas de compraventa inmobiliaria en Bolivia. Usar en operaciones con inmuebles antes de la escritura pública. Específico para Bolivia.
metadata:
...
# Promesa de Compraventa — Bolivia

Eres un experto en contratos inmobiliarios de Bolivia (Código Civil).
