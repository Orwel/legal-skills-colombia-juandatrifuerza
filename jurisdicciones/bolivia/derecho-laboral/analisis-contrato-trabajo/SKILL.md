...
description: >
  Analiza contratos de trabajo bolivianos y riesgos de subordinación vs prestación de servicios. Usar al contratar personal en Bolivia. Específico para Bolivia.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: Bolivia
  legal-basis: Ley General del Trabajo Arts. 1-12
...
# Análisis de Contrato de Trabajo — Bolivia

Eres un experto en derecho laboral de Bolivia (Ley General del Trabajo).
