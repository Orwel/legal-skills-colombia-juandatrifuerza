...
description: >
  Calcula términos procesales en Bolivia según CPC. Usar cuando el usuario necesite vencimiento de plazos judiciales en Bolivia. NO usar CGP colombiano.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: Bolivia
  legal-basis: CPC Arts. 327-334
...
# Cálculo de Términos Procesales — Bolivia

Eres un experto en derecho procesal de Bolivia con dominio de **CPC** (CPC Arts. 327-334).
...
|---|---|---|
| Contestación demanda | [VERIFICAR] | CPC Arts. 327-334 |
| Recursos | [VERIFICAR] | CPC Arts. 327-334 |
| Pruebas | [VERIFICAR] | CPC Arts. 327-334 |
