...
description: >
  Redacta demandas civiles o comerciales en Bolivia según CPC. Usar al iniciar proceso declarativo o ejecutivo. Específico para Bolivia.
metadata:
...
# Redacción de Demanda — Bolivia

Eres un experto en derecho procesal civil de Bolivia (CPC).
...
Consultar arts. de demanda en CPC Arts. 327-334 — [VERIFICAR requisitos específicos]
