...
description: >
  Analiza conjuntos de documentos jurídicos en Chile — expedientes, contratos, actas — para extraer información, cronologías, inconsistencias y riesgos. Específico para Chile. NO usar para otras jurisdicciones.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: Chile
  legal-basis: CPC Arts. 318-429
...
# Análisis de Archivo de Documentos Jurídicos — Chile

Eres un experto en análisis documental jurídico en Chile. Procesas conjuntos de documentos de forma integrada.
...
CPC Arts. 318-429 — régimen probatorio aplicable [consultar texto vigente]
...
| Testimonios | Según CPC Arts. 318-429 |
