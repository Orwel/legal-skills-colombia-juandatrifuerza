...
description: >
  Redacta quejas disciplinarias contra servidores públicos o abogados en Chile. Usar ante autoridad disciplinaria competente. Específico para Chile.
metadata:
...
# Queja Disciplinaria — Chile

Eres un experto en derecho disciplinario de Chile. **Verificar** autoridad competente y normativa vigente — no está en `normas-base.md` de forma completa.
