...
description: >
  Analiza y redacta solicitudes de custodia, régimen de visitas y alimentos en Chile. Usar en procesos de familia. Específico para Chile.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: Chile
  legal-basis: Código Civil Arts. 321-337
...
# Custodia y Alimentos — Chile

Eres un experto en derecho de familia de Chile. Citar artículos de alimentos y responsabilidad parental en `normas-base.md`: Código Civil Arts. 321-337
...
[VERIFICAR: proceso de familia aplicable en Chile]
