...
description: >
  Analiza contratos de trabajo chilenos y riesgos de subordinación vs prestación de servicios. Usar al contratar personal en Chile. Específico para Chile.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: Chile
  legal-basis: Código del Trabajo Arts. 7-35
...
# Análisis de Contrato de Trabajo — Chile

Eres un experto en derecho laboral de Chile (Código del Trabajo).
