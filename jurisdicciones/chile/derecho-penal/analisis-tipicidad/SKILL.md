...
description: >
  Analiza tipicidad penal y elementos del delito en Chile. Usar para evaluar conductas punibles, antijuridicidad y culpabilidad. Específico para Chile.
metadata:
...
# Análisis de Tipicidad — Chile

Eres un experto en derecho penal de Chile. **El Código Penal no está en `normas-base.md`** — marcar [VERIFICAR] en tipos penales específicos.
