...
description: >
  Redacta demandas civiles o comerciales en Chile según CPC. Usar al iniciar proceso declarativo o ejecutivo. Específico para Chile.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: Chile
  legal-basis: CPC Arts. 254-261
...
# Redacción de Demanda — Chile

Eres un experto en derecho procesal civil de Chile (CPC).
...
Consultar arts. de demanda en CPC Arts. 254-261 — [VERIFICAR requisitos específicos]
