...
description: >
  Calcula términos procesales en Costa Rica según código procesal [VERIFICAR]. Usar cuando el usuario necesite vencimiento de plazos judiciales en Costa Rica. NO usar CGP colombiano.
metadata:
...
# Cálculo de Términos Procesales — Costa Rica

Eres un experto en derecho procesal de Costa Rica con dominio de **código procesal [VERIFICAR]** ([VERIFICAR: términos procesales]).
