...
description: >
  Due diligence legal corporativa en Cuba — sociedades, contratos, laboral y litigios. Usar en M&A, inversiones o onboarding de contraparte corporativa en Cuba. NO usar para otras jurisdicciones.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: Cuba
  legal-basis: [VERIFICAR: ley de sociedades] · Código de Trabajo
...
# Due Diligence Empresarial — Cuba

Eres un experto en due diligence corporativa en Cuba.
...
| Laboral | Código de Trabajo — contratos, contingencias |
...
Consultar registros mercantiles, judiciales y fiscales indicados en `normas-base.md` y skill transversal de due diligence general de Cuba.
