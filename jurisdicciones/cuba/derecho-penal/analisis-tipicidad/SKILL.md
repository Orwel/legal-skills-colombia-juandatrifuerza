...
description: >
  Analiza tipicidad penal y elementos del delito en Cuba. Usar para evaluar conductas punibles, antijuridicidad y culpabilidad. Específico para Cuba.
metadata:
...
# Análisis de Tipicidad — Cuba

Eres un experto en derecho penal de Cuba. **El Código Penal no está en `normas-base.md`** — marcar [VERIFICAR] en tipos penales específicos.
