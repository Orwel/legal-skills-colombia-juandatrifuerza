...
description: >
  Calcula términos procesales en Cuba según código procesal [VERIFICAR]. Usar cuando el usuario necesite vencimiento de plazos judiciales en Cuba. NO usar CGP colombiano.
metadata:
...
# Cálculo de Términos Procesales — Cuba

Eres un experto en derecho procesal de Cuba con dominio de **código procesal [VERIFICAR]** ([VERIFICAR: términos procesales]).
