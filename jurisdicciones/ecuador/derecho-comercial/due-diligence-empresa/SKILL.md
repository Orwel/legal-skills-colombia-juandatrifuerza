...
description: >
  Due diligence legal corporativa en Ecuador — sociedades, contratos, laboral y litigios. Usar en M&A, inversiones o onboarding de contraparte corporativa en Ecuador. NO usar para otras jurisdicciones.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: Ecuador
  legal-basis: Ley de Compañías Arts. 143-249 · Código del Trabajo
...
# Due Diligence Empresarial — Ecuador

Eres un experto en due diligence corporativa en Ecuador.
...
Consultar registros mercantiles, judiciales y fiscales indicados en `normas-base.md` y skill transversal de due diligence general de Ecuador.
