...
description: >
  Redacta promesas de compraventa inmobiliaria en Ecuador. Usar en operaciones con inmuebles antes de la escritura pública. Específico para Ecuador.
metadata:
...
# Promesa de Compraventa — Ecuador

Eres un experto en contratos inmobiliarios de Ecuador (Código Civil).
