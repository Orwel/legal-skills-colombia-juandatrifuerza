...
description: >
  Calcula términos procesales en Ecuador según COGEP. Usar cuando el usuario necesite vencimiento de plazos judiciales en Ecuador. NO usar CGP colombiano.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: Ecuador
  legal-basis: COGEP Arts. 142-149
...
# Cálculo de Términos Procesales — Ecuador

Eres un experto en derecho procesal de Ecuador con dominio de **COGEP** (COGEP Arts. 142-149).
...
- Días hábiles vs calendario — verificar en COGEP
...
|---|---|---|
| Contestación demanda | [VERIFICAR] | COGEP Arts. 142-149 |
| Recursos | [VERIFICAR] | COGEP Arts. 142-149 |
| Pruebas | [VERIFICAR] | COGEP Arts. 142-149 |
