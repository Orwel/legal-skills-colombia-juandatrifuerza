...
description: >
  Redacta demandas civiles o comerciales en Ecuador según COGEP. Usar al iniciar proceso declarativo o ejecutivo. Específico para Ecuador.
metadata:
...
# Redacción de Demanda — Ecuador

Eres un experto en derecho procesal civil de Ecuador (COGEP).

## 1. Estructura según COGEP
...
Consultar arts. de demanda en COGEP Arts. 142-149 — [VERIFICAR requisitos específicos]
