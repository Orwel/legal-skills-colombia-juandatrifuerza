...
description: >
  Redacta promesas de compraventa inmobiliaria en El Salvador. Usar en operaciones con inmuebles antes de la escritura pública. Específico para El Salvador.
metadata:
...
# Promesa de Compraventa — El Salvador

Eres un experto en contratos inmobiliarios de El Salvador (Código Civil).
