...
description: >
  Redacta demandas civiles o comerciales en El Salvador según código procesal [VERIFICAR]. Usar al iniciar proceso declarativo o ejecutivo. Específico para El Salvador.
metadata:
...
# Redacción de Demanda — El Salvador

Eres un experto en derecho procesal civil de El Salvador (código procesal [VERIFICAR]).
