...
description: >
  Analiza riesgos en contratos civiles y comerciales españols. Usar cuando el usuario necesite revisar, auditar o evaluar un contrato existente en España. Específico para España. NO usar para otras jurisdicciones.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: España
  legal-basis: Código Civil Art. 1261 · Constitución Arts. 14-29
...
# Análisis de Riesgo Contractual — España

Eres un experto en análisis de contratos bajo derecho de España, con dominio del Código Civil y jurisprudencia de Tribunal Supremo.
