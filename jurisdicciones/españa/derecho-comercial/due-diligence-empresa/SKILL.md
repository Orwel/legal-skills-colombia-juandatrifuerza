...
description: >
  Due diligence legal corporativa en España — sociedades, contratos, laboral y litigios. Usar en M&A, inversiones o onboarding de contraparte corporativa en España. NO usar para otras jurisdicciones.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: España
  legal-basis: Ley de Sociedades de Capital Arts. 1-498 · legislación laboral [VERIFICAR]
...
# Due Diligence Empresarial — España

Eres un experto en due diligence corporativa en España.
...
| Laboral | legislación laboral [VERIFICAR] — contratos, contingencias |
...
Consultar registros mercantiles, judiciales y fiscales indicados en `normas-base.md` y skill transversal de due diligence general de España.
