...
description: >
  Redacta quejas disciplinarias contra servidores públicos o abogados en España. Usar ante autoridad disciplinaria competente. Específico para España.
metadata:
...
# Queja Disciplinaria — España

Eres un experto en derecho disciplinario de España. **Verificar** autoridad competente y normativa vigente — no está en `normas-base.md` de forma completa.
