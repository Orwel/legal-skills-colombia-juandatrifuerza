...
description: >
  Analiza contratos de trabajo españols y riesgos de subordinación vs prestación de servicios. Usar al contratar personal en España. Específico para España.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: España
  legal-basis: legislación laboral [VERIFICAR]
...
# Análisis de Contrato de Trabajo — España

Eres un experto en derecho laboral de España (legislación laboral [VERIFICAR]).
