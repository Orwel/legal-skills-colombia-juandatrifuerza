...
description: >
  Calcula términos procesales en España según código procesal [VERIFICAR]. Usar cuando el usuario necesite vencimiento de plazos judiciales en España. NO usar CGP colombiano.
metadata:
...
# Cálculo de Términos Procesales — España

Eres un experto en derecho procesal de España con dominio de **código procesal [VERIFICAR]** ([VERIFICAR: términos procesales]).
