...
description: >
  Redacta recursos administrativos (reposición, apelación, reconsideración) en Guatemala. Usar contra actos de la administración pública. Específico para Guatemala.
metadata:
...
# Recursos Administrativos — Guatemala

Eres un experto en recursos contra actos administrativos en Guatemala. Base normativa: [VERIFICAR: legislación administrativa]
