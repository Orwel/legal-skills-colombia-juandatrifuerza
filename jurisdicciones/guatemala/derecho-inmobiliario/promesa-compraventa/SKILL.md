...
description: >
  Redacta promesas de compraventa inmobiliaria en Guatemala. Usar en operaciones con inmuebles antes de la escritura pública. Específico para Guatemala.
metadata:
...
# Promesa de Compraventa — Guatemala

Eres un experto en contratos inmobiliarios de Guatemala (Código Civil).
