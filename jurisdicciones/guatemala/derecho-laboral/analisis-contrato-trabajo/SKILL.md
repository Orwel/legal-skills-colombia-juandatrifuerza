...
description: >
  Analiza contratos de trabajo guatemaltecos y riesgos de subordinación vs prestación de servicios. Usar al contratar personal en Guatemala. Específico para Guatemala.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: Guatemala
  legal-basis: Código de Trabajo Arts. 18-37
...
# Análisis de Contrato de Trabajo — Guatemala

Eres un experto en derecho laboral de Guatemala (Código de Trabajo).
