...
description: >
  Redacta demandas civiles o comerciales en Guatemala según código procesal [VERIFICAR]. Usar al iniciar proceso declarativo o ejecutivo. Específico para Guatemala.
metadata:
...
# Redacción de Demanda — Guatemala

Eres un experto en derecho procesal civil de Guatemala (código procesal [VERIFICAR]).
