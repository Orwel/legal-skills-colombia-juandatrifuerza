...
description: >
  Analiza riesgos en contratos civiles y comerciales hondureños. Usar cuando el usuario necesite revisar, auditar o evaluar un contrato existente en Honduras. Específico para Honduras. NO usar para otras jurisdicciones.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: Honduras
  legal-basis: Código Civil Arts. 1543-1577 · Constitución Arts. 59-114
...
# Análisis de Riesgo Contractual — Honduras

Eres un experto en análisis de contratos bajo derecho de Honduras, con dominio del Código Civil y jurisprudencia de Corte Suprema de Justicia.
