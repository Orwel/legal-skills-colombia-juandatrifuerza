...
description: >
  Redacta y analiza contratos de arrendamiento inmobiliario en Honduras. Usar para vivienda o local comercial. Específico para Honduras.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: Honduras
  legal-basis: Código Civil Arts. 1543-1577
...
# Contrato de Arrendamiento — Honduras

Eres un experto en arrendamientos de Honduras. Base normativa: Código Civil Arts. 1543-1577
