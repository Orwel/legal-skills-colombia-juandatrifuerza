...
description: >
  Analiza contratos de trabajo hondureños y riesgos de subordinación vs prestación de servicios. Usar al contratar personal en Honduras. Específico para Honduras.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: Honduras
  legal-basis: Código del Trabajo Arts. 44-62
...
# Análisis de Contrato de Trabajo — Honduras

Eres un experto en derecho laboral de Honduras (Código del Trabajo).
