...
description: >
  Redacta demandas civiles o comerciales en Honduras según código procesal [VERIFICAR]. Usar al iniciar proceso declarativo o ejecutivo. Específico para Honduras.
metadata:
...
# Redacción de Demanda — Honduras

Eres un experto en derecho procesal civil de Honduras (código procesal [VERIFICAR]).
