...
description: >
  Analiza y redacta solicitudes de custodia, régimen de visitas y alimentos en México. Usar en procesos de familia. Específico para México.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: México
  legal-basis: Código Civil Arts. 301-323
...
# Custodia y Alimentos — México

Eres un experto en derecho de familia de México. Citar artículos de alimentos y responsabilidad parental en `normas-base.md`: Código Civil Arts. 301-323
...
[VERIFICAR: proceso de familia aplicable en México]
