...
description: >
  Analiza tipicidad penal y elementos del delito en México. Usar para evaluar conductas punibles, antijuridicidad y culpabilidad. Específico para México.
metadata:
...
# Análisis de Tipicidad — México

Eres un experto en derecho penal de México. **El Código Penal no está en `normas-base.md`** — marcar [VERIFICAR] en tipos penales específicos.
