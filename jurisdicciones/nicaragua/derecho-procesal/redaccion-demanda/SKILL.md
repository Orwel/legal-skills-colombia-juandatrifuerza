...
description: >
  Redacta demandas civiles o comerciales en Nicaragua según código procesal [VERIFICAR]. Usar al iniciar proceso declarativo o ejecutivo. Específico para Nicaragua.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: Nicaragua
  legal-basis: [VERIFICAR: demanda]
...
# Redacción de Demanda — Nicaragua

Eres un experto en derecho procesal civil de Nicaragua (código procesal [VERIFICAR]).

## 1. Estructura según código procesal [VERIFICAR]
...
Consultar arts. de demanda en [VERIFICAR: demanda] — [VERIFICAR requisitos específicos]
