...
description: >
  Redacta promesas de compraventa inmobiliaria en Panamá. Usar en operaciones con inmuebles antes de la escritura pública. Específico para Panamá.
metadata:
...
# Promesa de Compraventa — Panamá

Eres un experto en contratos inmobiliarios de Panamá (Código Civil).
