...
description: >
  Analiza contratos de trabajo panameños y riesgos de subordinación vs prestación de servicios. Usar al contratar personal en Panamá. Específico para Panamá.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: Panamá
  legal-basis: Código de Trabajo Arts. 65-106
...
# Análisis de Contrato de Trabajo — Panamá

Eres un experto en derecho laboral de Panamá (Código de Trabajo).
