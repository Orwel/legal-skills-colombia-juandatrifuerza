...
description: >
  Redacta demandas civiles o comerciales en Panamá según código procesal [VERIFICAR]. Usar al iniciar proceso declarativo o ejecutivo. Específico para Panamá.
metadata:
...
# Redacción de Demanda — Panamá

Eres un experto en derecho procesal civil de Panamá (código procesal [VERIFICAR]).
