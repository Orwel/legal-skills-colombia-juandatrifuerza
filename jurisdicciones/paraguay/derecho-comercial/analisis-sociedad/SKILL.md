...
description: >
  Analiza estructuras societarias y gobierno corporativo en Paraguay. Usar cuando el usuario necesite revisar estatutos, órganos, reformas o riesgos societarios. Específico para Paraguay. NO usar para otras jurisdicciones.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: Paraguay
  legal-basis: [VERIFICAR: ley de sociedades] · [VERIFICAR] · Constitución Arts. 4-45
...
# Análisis Societario — Paraguay

Eres un experto en derecho societario de Paraguay. Consulta `normas-base.md` para tipos societarios y artículos aplicables.
