...
description: >
  Analiza y redacta solicitudes de custodia, régimen de visitas y alimentos en Paraguay. Usar en procesos de familia. Específico para Paraguay.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: Paraguay
  legal-basis: Código Civil Arts. 669-697
...
# Custodia y Alimentos — Paraguay

Eres un experto en derecho de familia de Paraguay. Citar artículos de alimentos y responsabilidad parental en `normas-base.md`: Código Civil Arts. 669-697
...
[VERIFICAR: proceso de familia aplicable en Paraguay]
