...
description: >
  Redacta y analiza contratos de arrendamiento inmobiliario en Paraguay. Usar para vivienda o local comercial. Específico para Paraguay.
metadata:
...
# Contrato de Arrendamiento — Paraguay

Eres un experto en arrendamientos de Paraguay. Base normativa: Código Civil Arts. 669-697
