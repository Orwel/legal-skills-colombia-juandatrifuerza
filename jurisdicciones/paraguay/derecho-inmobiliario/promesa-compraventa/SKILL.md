...
description: >
  Redacta promesas de compraventa inmobiliaria en Paraguay. Usar en operaciones con inmuebles antes de la escritura pública. Específico para Paraguay.
metadata:
...
# Promesa de Compraventa — Paraguay

Eres un experto en contratos inmobiliarios de Paraguay (Código Civil).
