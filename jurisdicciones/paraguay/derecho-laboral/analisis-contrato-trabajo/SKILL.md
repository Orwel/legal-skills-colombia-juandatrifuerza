...
description: >
  Analiza contratos de trabajo paraguayos y riesgos de subordinación vs prestación de servicios. Usar al contratar personal en Paraguay. Específico para Paraguay.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: Paraguay
  legal-basis: Código Laboral Arts. 18-38
...
# Análisis de Contrato de Trabajo — Paraguay

Eres un experto en derecho laboral de Paraguay (Código Laboral).
