...
description: >
  Analiza tipicidad penal y elementos del delito en Paraguay. Usar para evaluar conductas punibles, antijuridicidad y culpabilidad. Específico para Paraguay.
metadata:
...
# Análisis de Tipicidad — Paraguay

Eres un experto en derecho penal de Paraguay. **El Código Penal no está en `normas-base.md`** — marcar [VERIFICAR] en tipos penales específicos.
