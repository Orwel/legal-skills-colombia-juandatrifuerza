...
description: >
  Redacta demandas civiles o comerciales en Paraguay según CPC. Usar al iniciar proceso declarativo o ejecutivo. Específico para Paraguay.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: Paraguay
  legal-basis: CPC Arts. 215-220
...
# Redacción de Demanda — Paraguay

Eres un experto en derecho procesal civil de Paraguay (CPC).
...
Consultar arts. de demanda en CPC Arts. 215-220 — [VERIFICAR requisitos específicos]
