...
description: >
  Redacta promesas de compraventa inmobiliaria en Perú. Usar en operaciones con inmuebles antes de la escritura pública. Específico para Perú.
metadata:
...
# Promesa de Compraventa — Perú

Eres un experto en contratos inmobiliarios de Perú (Código Civil).
