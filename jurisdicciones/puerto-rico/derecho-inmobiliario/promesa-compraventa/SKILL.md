...
description: >
  Redacta promesas de compraventa inmobiliaria en Puerto Rico. Usar en operaciones con inmuebles antes de la escritura pública. Específico para Puerto Rico.
metadata:
...
# Promesa de Compraventa — Puerto Rico

Eres un experto en contratos inmobiliarios de Puerto Rico (Código Civil).
