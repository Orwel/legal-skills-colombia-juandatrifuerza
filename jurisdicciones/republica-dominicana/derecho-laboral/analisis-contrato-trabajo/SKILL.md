...
description: >
  Analiza contratos de trabajo dominicanos y riesgos de subordinación vs prestación de servicios. Usar al contratar personal en República Dominicana. Específico para República Dominicana.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: República Dominicana
  legal-basis: Código de Trabajo Arts. 14-55
...
# Análisis de Contrato de Trabajo — República Dominicana

Eres un experto en derecho laboral de República Dominicana (Código de Trabajo).
