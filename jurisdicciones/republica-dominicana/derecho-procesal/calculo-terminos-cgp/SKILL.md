...
description: >
  Calcula términos procesales en República Dominicana según código procesal [VERIFICAR]. Usar cuando el usuario necesite vencimiento de plazos judiciales en República Dominicana. NO usar CGP colombiano.
metadata:
...
# Cálculo de Términos Procesales — República Dominicana

Eres un experto en derecho procesal de República Dominicana con dominio de **código procesal [VERIFICAR]** ([VERIFICAR: términos procesales]).
