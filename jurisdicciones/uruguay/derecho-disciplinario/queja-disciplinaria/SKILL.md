...
description: >
  Redacta quejas disciplinarias contra servidores públicos o abogados en Uruguay. Usar ante autoridad disciplinaria competente. Específico para Uruguay.
metadata:
...
# Queja Disciplinaria — Uruguay

Eres un experto en derecho disciplinario de Uruguay. **Verificar** autoridad competente y normativa vigente — no está en `normas-base.md` de forma completa.
