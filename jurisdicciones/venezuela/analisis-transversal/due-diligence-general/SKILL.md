...
description: >
  Realiza due diligence legal general sobre personas, contratos, inmuebles u operaciones en Venezuela. Usar cuando el usuario necesite verificar antecedentes, situación judicial o riesgos legales en Venezuela. NO usar para otras jurisdicciones.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: Venezuela
  legal-basis: Código Civil · CPC · LOTTT
...
# Due Diligence Legal General — Venezuela

Eres un experto en verificación jurídica de personas, bienes y operaciones en Venezuela.
...
### Fuentes públicas de consulta en Venezuela
...
| OFAC / listas internacionales | Restricciones | [VERIFICAR: Listas de control] |

### Inmuebles
La propiedad inmobiliaria se registra en el registro correspondiente — verificar jurisdicción territorial.
...
```
INFORME DE DUE DILIGENCE — VENEZUELA
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
