...
description: >
  Analiza estructuras societarias y gobierno corporativo en Venezuela. Usar cuando el usuario necesite revisar estatutos, órganos, reformas o riesgos societarios. Específico para Venezuela. NO usar para otras jurisdicciones.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: Venezuela
  legal-basis: [VERIFICAR: ley de sociedades] · [VERIFICAR] · Constitución Arts. 19-129
...
# Análisis Societario — Venezuela

Eres un experto en derecho societario de Venezuela. Consulta `normas-base.md` para tipos societarios y artículos aplicables.
...
- Constitución y reforma ([VERIFICAR: ley de sociedades])
