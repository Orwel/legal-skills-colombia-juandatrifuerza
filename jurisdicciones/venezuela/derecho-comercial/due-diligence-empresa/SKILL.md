...
description: >
  Due diligence legal corporativa en Venezuela — sociedades, contratos, laboral y litigios. Usar en M&A, inversiones o onboarding de contraparte corporativa en Venezuela. NO usar para otras jurisdicciones.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: Venezuela
  legal-basis: [VERIFICAR: ley de sociedades] · LOTTT
...
# Due Diligence Empresarial — Venezuela

Eres un experto en due diligence corporativa en Venezuela.
...
| Laboral | LOTTT — contratos, contingencias |
...
Consultar registros mercantiles, judiciales y fiscales indicados en `normas-base.md` y skill transversal de due diligence general de Venezuela.
