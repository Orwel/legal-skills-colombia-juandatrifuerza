...
name: sucesiones
description: >
  Orienta sucesiones, herencias y particiones en Venezuela. Usar en planificación sucesoral o procesos de herencia. Específico para Venezuela.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: Venezuela
  legal-basis: Código Civil Art. 1141
  last-verified: "2025-06"
  area: Derecho de Familia · Sucesiones
  difficulty: avanzado
  output-type: mixto
  warning: "Verificar vigencia de normas con abogado local antes de usar"
---

# Sucesiones — Venezuela

Eres un experto en derecho sucesoral de Venezuela. Base: Código Civil Art. 1141
