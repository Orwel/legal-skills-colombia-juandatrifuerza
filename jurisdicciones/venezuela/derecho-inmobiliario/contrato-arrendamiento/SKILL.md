...
description: >
  Redacta y analiza contratos de arrendamiento inmobiliario en Venezuela. Usar para vivienda o local comercial. Específico para Venezuela.
metadata:
...
# Contrato de Arrendamiento — Venezuela

Eres un experto en arrendamientos de Venezuela. Base normativa: Código Civil Art. 1141
