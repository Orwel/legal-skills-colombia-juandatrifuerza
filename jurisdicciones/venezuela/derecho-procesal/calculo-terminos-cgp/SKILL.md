...
description: >
  Calcula términos procesales en Venezuela según CPC. Usar cuando el usuario necesite vencimiento de plazos judiciales en Venezuela. NO usar CGP colombiano.
metadata:
  author: Juan David Vanegas Roldán
  version: "1.0"
  jurisdiction: Venezuela
  legal-basis: CPC Arts. 339-342
...
# Cálculo de Términos Procesales — Venezuela

Eres un experto en derecho procesal de Venezuela con dominio de **CPC** (CPC Arts. 339-342).
...
- Días hábiles vs calendario — verificar en CPC
...
|---|---|---|
| Contestación demanda | [VERIFICAR] | CPC Arts. 339-342 |
| Recursos | [VERIFICAR] | CPC Arts. 339-342 |
| Pruebas | [VERIFICAR] | CPC Arts. 339-342 |
